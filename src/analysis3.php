...
<div class="container">
  ...
  <div class="card-content">
    ...
    $con=mysqli_connect("localhost","root","password","shoplada");
     ...
     $amount = $_GET['amount'];
      $sql = "SELECT p.promoname AS Promotion, COUNT(od.OrderID) AS Amount
              FROM promotion p, customerorder od, voucher v
              WHERE p.promoid = v.promoid AND v.voucherid = od.voucherid
              GROUP BY p.promoid
