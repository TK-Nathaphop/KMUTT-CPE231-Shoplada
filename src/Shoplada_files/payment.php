...
<?php
    ...
    $PrimaryKeyAddress = sprintf('ADDRESS-%d',$id+1  );
    if(isset($_POST['submit_button']))
    {
      $sqlInsertAddress ="Insert INTO address(AddressID,Phone,Address,Province,District,Road,Postcode,UserID) 
      VALUES($PrimaryKeyAddress,$_POST['Phone'],$_POST['Address'],$_POST['Province'],$_POST['District'],$_POST['Road'],$_POST['Postcode'],$userid)";
