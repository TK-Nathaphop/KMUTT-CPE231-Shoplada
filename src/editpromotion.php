...
<div class="container">
  ...
  $sql = "SELECT promoid, promoname, DATE_FORMAT(startdate, '%d/%m/%Y'), DATE_FORMAT(expiredate, '%d/%m/%Y'), discountorder, `condition` FROM promotion WHERE promoid = '$promoid'";
  $result = mysqli_query($con,$sql);
  if($promotion = mysqli_fetch_row($result))
    {
    echo '<form action="php/update_promotion.php" method="get">
    ...
    <div class="card-content">
        ...
        <div class="row">
          <div class="input-field col s12 m12 l12 xl12">
            <input name="promo_name" id="promo_name" type="text" class="validate" value = "'.$promotion[1].'"required/>
        ...
        <div class = "row">
          <div class="input-field col s6 m6 l6 xl6">
            ...
            <input name="start_date" id="start_date" type="text" class="datepicker" value = "'.$promotion[2].'" required/>
            <label for="start_date">Start Date</label>
          </div>
          <div class="input-field col s6 m6 l6 xl6">
            <i class="material-icons prefix">date_range</i>
            <input name="expire_date" id="expire_date" type="text" class="datepicker" value = "'.$promotion[3].'" required/>
            <label for="expire_date">Expire Date</label>
          </div>
        </div> 
        <div class="row">
          <div class="input-field col s6 m6 l6 xl6">
            <input name="condition" id="discount" type="text" class="validate" value = "'.$promotion[5].'" required/>
            <label for="condition">Condition</label>
          </div>
          <div class="input-field col s6 m6 l6 xl6">
            <input name="discount" id="discount" type="text" class="validate" value = "'.$promotion[4].'" required/>
    ...
    <button class="btn waves-light card-panel green" type="submit" name="action" value="'.$promoid.'">Submit<i class="material-icons right">send</i></button>
    </form>';
    }
  else
    echo "<script type='text/javascript'>alert('Cannot find the promotion');location= 'http://e22vvb.asuscomm.com:43221/promotion.php';</script>";
  ?>
</div>
